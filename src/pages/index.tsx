        ...
        <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
            ...
            <Card className={cn('w-[380px]')}>
                <CardHeader>
                    ...
                    <CardDescription>나랑 친구가 되어줄래</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                            ...
                            >
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            {/* 라벨을 표시합니다. */}
                                            <FormLabel>이름 좀 알려줄래</FormLabel>
                                            <FormControl>
                                                {/* 이름 입력 필드를 렌더링합니다. */}
                                                <Input placeholder="난 부끄부끄야" {...field} />
                                            </FormControl>
                                            {/* 폼 메시지 컴포넌트를 표시합니다. */}
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>이메일 좀 알려줄래</FormLabel>
                                            <FormControl>
                                                <Input placeholder="bukebuke@buk.kk" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>연락처 좀 알려줄래</FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>우리는</FormLabel>
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="어떤 사이" />
                                                    </SelectTrigger>
                                                </FormControl>
                                                <SelectContent>
                                                    <SelectItem value="select1">친구사이</SelectItem>
                                                    <SelectItem value="select2">가족사이</SelectItem>
                                                    <SelectItem value="select3">연인사이</SelectItem>
                                                    <SelectItem value="select4">동료사이</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                        </FormItem>
